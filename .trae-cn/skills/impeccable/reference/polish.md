...
```bash
.trae-cn/skills/impeccable/scripts/impeccable critique-storage latest "<resolved target>" --json
```
...
```bash
.trae-cn/skills/impeccable/scripts/impeccable critique-storage close "<resolved target>" "<snapshot_file returned by latest>"
```
